...
#usethis::git_sitrep()
#usethis::create_github_token() ## create Personal Access Token
#gitcreds::gitcreds_set() ## prompt to insert PAT
#usethis::use_git() ##track current project (can also use Tools > Project Options … > Git/SVN, and set to Git)
