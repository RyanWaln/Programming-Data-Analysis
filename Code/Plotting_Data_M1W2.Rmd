...
Workspace: D:/Tri 2 2026/Techniques in Marine Science 1/Programming & Data Analysis/Code/Plotting_Data_M1W2.Rmd
---
#Use gear sign to edit knitr outpouts
...
#PINNED Change count (a summary) to identify which uses raw values. (Required for when you want to change defaults ) 
```{r}
demo <- tribble(
  ~cut,         ~freq,
  "Fair",       1610,
