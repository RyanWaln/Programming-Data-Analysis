...
#### Shortcuts
To create new chunk: Ctrl + Alt + I 
To run selected line: Ctrl + Enter
...
```{r remove packages, message=FALSE, warning=FALSE, include=FALSE}
## Can also remove packages in packages tab
# remove.packages()
```
